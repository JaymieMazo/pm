...
Begin VB.Form F_MaterialConsumption 
   ...
   Begin OsenXPCntrl.OsenXPButton cmdView 
      ...
      MCOL            =   12632256
      MPTR            =   0
      MICON           =   "F_MaterialConsumption.frx":0CCA
      PICN            =   "F_MaterialConsumption.frx":0CE6
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin OsenXPCntrl.OsenXPButton cmdClose 
      ...
      MCOL            =   12632256
      MPTR            =   0
      MICON           =   "F_MaterialConsumption.frx":1282
      PICN            =   "F_MaterialConsumption.frx":129E
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin OsenXPCntrl.OsenXPButton cmdExcel 
      ...
      MCOL            =   12632256
      MPTR            =   0
      MICON           =   "F_MaterialConsumption.frx":183A
      PICN            =   "F_MaterialConsumption.frx":1856
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
