...
Private Sub cmdTest_Click()
     ...
     With hflxViewMaterial
          ...
          For lngLoop = 1 To rs.RecordCount - 1
               ...
               Set rs1 = clsDB.GetRecordSet("Select TOP 1 qty from GetStockBalance('" & Format(.TextMatrix(lngLoop, 9), "yyyy/mm/dd") & "') Where ItemId = '" & .TextMatrix(lngLoop, 3) & "'")
               
               Set rs2 = clsDB.GetRecordSet("Select TOP 1 Qty from GetStockBalance('" & Format(.TextMatrix(lngLoop, 10), "yyyy/mm/dd") & "') Where ItemId = '" & .TextMatrix(lngLoop, 3) & "'")
